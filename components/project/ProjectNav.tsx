      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button className="px-2 py-1 text-xs text-white transition-colors flex items-center gap-1.5 bg-white/5 hover:bg-white/20 rounded-lg">
              <svg
                className="w-3 h-3"
                fill="none"
                stroke="currentColor"
          ...
          >
            ...
            <div className="mb-2 p-3 bg-black/5 rounded-xl">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-black/80 font-mono truncate flex-1 overflow-x-auto">
