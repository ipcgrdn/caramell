...
Each section below provides OPTIONS to choose from.
Select ONE option per section that best fits the website's purpose and style.
These are ingredients to pick from, NOT rules that must all be followed.
...
<TESTIMONIAL>
Content Options (choose one, apply infinite marquee animation with duplicated items and alpha mask):
