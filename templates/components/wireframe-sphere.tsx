...
export function AnomalousMatterHero({
  ...
  return (
    <section
      role="banner"
      className="relative w-full h-screen bg-black text-[hsl(var(--foreground))] overflow-hidden"
    >
      <Suspense fallback={<div className="w-full h-full bg-[hsl(var(--background))]" />}>
        <GenerativeArtScene />
      </Suspense>

      <div className="absolute inset-0 bg-linear-to-t from-[hsl(var(--background))] via-[hsl(var(--background))/70] to-transparent z-10" />
